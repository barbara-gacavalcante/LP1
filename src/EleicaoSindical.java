...
public class EleicaoSindical {
    ...
    static void compute() {
        ...
        int votosNulos; int votosBrancos; int votosVal; int total; int A; int B; int C; float PV; float PN; float Pb; float PA; float PB; float PC;
        ...
        System.out.println("Votos válidos: " + votosVal + "; Votos total: " + total + "; VotosA: " + A + "; VotosB: " + B + "; VotosC: " + C);
